                ...
                <div className="showcaselayout flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="first-project-wrapper flex-1 lg:w-3/5" ref={project1Ref}>
                        <div className="image-wrapper relative h-[400px] lg:h-[600px] rounded-3xl overflow-hidden shadow-sm border border-gray-100 bg-[#F4F8FB]">
                            ...
                            <img src="/images/optomap.jpg" alt="Optos OPTOMAP Instrument" className="w-full h-full object-contain  transition-transform duration-700 ease-out hover:scale-105" />
                    ...
                    <div className="project-list-wrapper flex-1 lg:w-2/5 flex flex-col gap-8">
                        ...
                        <div className="project group cursor-pointer" ref={project3Ref}>
                            <div className="image-wrapper relative h-64 md:h-72 rounded-3xl overflow-hidden bg-[#E6FAFA] transition-transform duration-300 group-hover:-translate-y-2">
                                {/* Make sure you have the visual fields image saved in your public/images folder! */}
                                <img src="/images/visual-field.jpg" alt="Visual Fields Instrument" className="w-full h-full object-contain p-6 mix-blend-multiply" />
                            </div>
                            <h2 className="text-xl font-bold text-gray-900 mt-4 group-hover:text-blue-600 transition-colors">Visual Fields Instrument</h2>
                            <p className="text-gray-500 text-sm mt-1">Comprehensive testing to map your peripheral vision and detect blind spots.</p>
                        </div>
